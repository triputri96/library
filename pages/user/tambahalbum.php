...
<body>
    <div class="container">
        ...
        <form action="../../app/service/tambah_album.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" class="form-control" id="album_id" name="album_id" value="<?php echo isset($_GET['edit']) ? $album_id : ''; ?>" hidden>

            <div class="mb-3 row mt-5">
                <label for="nama_album" class="col-sm-2 col-form-label">Nama Album</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="nama_album" name="nama_album" value="<?php echo $nama_album; ?>">
                </div>
            </div>
            <div class="mb-3 row mt-5">
